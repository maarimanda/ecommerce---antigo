<?php if(!class_exists('Rain\Tpl')){exit;}?>   <div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/res/site/css/js/owl.carousel.min.js"></script>
    <script src="/res/site/css/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/res/site/css/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/res/site/css/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/res/site/css/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/res/site/css/js/script.slider.js"></script>
  </body>
</html>